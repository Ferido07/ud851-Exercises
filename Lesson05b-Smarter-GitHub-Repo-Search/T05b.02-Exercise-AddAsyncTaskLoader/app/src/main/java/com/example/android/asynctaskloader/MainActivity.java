...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Is not necessarily needed to load it here but loading in onCreate is the general pattern used.
         * As the instructor said in video number 84.
         * If it is not loaded here it would be loaded after the first click of search button in makeGithubSearchQuery.
         */
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                ...
                //don't know why it is needed to put it here the documentation clearly says it is used after
                //the loader is started by using isStarted().
                //just added it after checking the solution and further study is needed by testing or asking question.
                forceLoad();
            }
        };
    }
