...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            //intentFilter.addAction(Intent.ACTION_BATTERY_CHANGED);this code apparently didn't work
            ...
            int someExtra = intent.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            boolean isCharging = someExtra == BatteryManager.BATTERY_STATUS_CHARGING ||
                    someExtra == BatteryManager.BATTERY_STATUS_FULL;
