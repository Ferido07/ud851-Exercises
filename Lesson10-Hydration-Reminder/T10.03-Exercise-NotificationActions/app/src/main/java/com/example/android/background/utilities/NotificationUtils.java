...
public class NotificationUtils {
    ...
    private static final int ACTION_DISMISS_NOTIFICATION_PENDING_INTENT_ID = 37;
    private static int DRINK_WATER_ACTION_PENDING_INTENT_ID = 77;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context){
        Intent launchWaterReminderIntentService = new Intent(context, WaterReminderIntentService.class);
        launchWaterReminderIntentService.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);

        PendingIntent pendingIntent = PendingIntent.getService(
                context,
                ACTION_DISMISS_NOTIFICATION_PENDING_INTENT_ID,
                launchWaterReminderIntentService,
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(
                R.drawable.ic_local_drink_black_24px, "I Drank.", pendingIntent);
